...
namespace VTechClubApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private VTechClubApp.DAL.VTechContext context1;
        public AccountController()
        {
            context1 = new VTechContext();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                //        {
                //            return RedirectToAction("Create", "RegisterStudent");
                //        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    /*Directly after default registration the user will be assigned the User Role  "Mission done by the code below*/
                    var resultt = await UserManager.AddToRoleAsync(user.Id, "User");
